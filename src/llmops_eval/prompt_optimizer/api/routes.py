...
from src.llmops_eval.prompt_optimizer.experiments.framework import (
    ExperimentFramework,
    ExperimentConfig,
    ExperimentResult,
)
from src.llmops_eval.prompt_optimizer.variations.variation_generator import (
    VariationGenerator,
    VariationSet,
    VariationStrategy,
)
...
from src.llmops_eval.prompt_optimizer.selection.ranking import (
    PromptRanker,
    RankingMethod,
    RankingResult,
)
...
def get_experiment_framework() -> ExperimentFramework:
    ...
    if _experiment_framework is None:
        from src.llmops_eval.prompt_optimizer.experiments.framework import create_experiment_framework
...
def get_variation_generator() -> VariationGenerator:
    ...
    if _variation_generator is None:
        from src.llmops_eval.prompt_optimizer.variations.variation_generator import create_variation_generator
...
def get_selector() -> PromptSelector:
    ...
    if _selector is None:
        from src.llmops_eval.prompt_optimizer.selection.selector import create_prompt_selector
...
def get_ranker() -> PromptRanker:
    ...
    global _ranker
    if _ranker is None:
        from src.llmops_eval.prompt_optimizer.selection.ranking import create_prompt_ranker
...
def get_history() -> HistoryManager:
    ...
    global _history
    if _history is None:
        from src.llmops_eval.prompt_optimizer.history.history import create_history_manager
...
async def select_variant(
    ...
    try:
        ...
        from src.llmops_eval.prompt_optimizer.experiments.framework import VariantResult
        ...
        from src.llmops_eval.prompt_optimizer.experiments.ab_test import TestResult
