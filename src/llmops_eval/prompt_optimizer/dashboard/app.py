...
def get_template_manager():
    ...
    from src.llmops_eval.prompt_optimizer.templates import create_template_manager
...
def get_variation_generator():
    ...
    from src.llmops_eval.prompt_optimizer.variations import create_variation_generator
...
def get_experiment_framework():
    ...
    from src.llmops_eval.prompt_optimizer.experiments import create_experiment_framework
...
def get_history_manager():
    ...
    from src.llmops_eval.prompt_optimizer.history import create_history_manager
...
def get_prompt_selector():
    ...
    from src.llmops_eval.prompt_optimizer.selection.selector import BestPromptSelector, get_statistical_analyzer
...
def show_selection():
    ...
    try:
        ...
        if st.button("🏆 Select Best Prompt", type="primary"):
            try:
                from src.llmops_eval.prompt_optimizer.selection.selector import SelectionCriteria
